use super::super::fractal::FractalProfile;
use super::super::morphology::noise::SphericalNoise3d;
...
pub(in crate::generators::natural) fn synthesize_spherical_hotspot_offset(
