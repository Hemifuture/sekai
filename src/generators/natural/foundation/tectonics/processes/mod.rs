...
pub(super) mod constants {
    ...
    pub(in crate::generators::natural::foundation::tectonics) const OCEANIC_TRENCH_ELEVATION_M:
        f32 = -10_000.0;
    pub(in crate::generators::natural::foundation::tectonics) const HIGHEST_CONTINENTAL_ELEVATION_M: f32 = 10_000.0;
    pub(super) const ABYSSAL_PLAIN_ELEVATION_M: f32 = -6_000.0;
    pub(super) const SUBDUCTION_MAX_DISTANCE_M: f64 = 1_800_000.0;
    pub(in crate::generators::natural::foundation::tectonics) const SUBDUCTION_PEAK_DISTANCE_M:
        f64 = 600_000.0;
    pub(in crate::generators::natural::foundation::tectonics) const COLLISION_MAX_DISTANCE_M: f64 =
        4_200_000.0;
    pub(super) const COLLISION_COEFFICIENT_PER_KM: f64 = 1.3e-5;
    pub(in crate::generators::natural::foundation::tectonics) const REFERENCE_PLATE_SPEED_MM_PER_YEAR: f64 = 100.0;
    pub(in crate::generators::natural::foundation::tectonics) const BASE_SUBDUCTION_UPLIFT_MM_PER_YEAR: f64 = 0.6;
...
pub(in crate::generators::natural::foundation::tectonics) use subduction::subduction_profile;
