...
pub(in crate::generators::natural::foundation::tectonics) fn subduction_profile(
    distance_m: f64,
...
pub(in crate::generators::natural::foundation::tectonics) fn apply_subduction(
...
pub(in crate::generators::natural::foundation::tectonics) fn apply_subduction_v5(
    surface: &SphericalSurfaceSnapshot,
    events: &[ContactEvent],
    current: &TectonicState,
    next: &mut TectonicState,
