...
pub use global_circulation::{
    ...
    GLOBAL_CIRCULATION_MINIMUM_FAST_SUBSTEPS_PER_MACRO_STEP,
    ...
    P4_OPEN_OCEAN_SURFACE_ALBEDO, P4_REFERENCE_AIR_DENSITY_KG_M3, P4_SEA_ICE_SURFACE_ALBEDO,
    P4_SNOW_FREE_LAND_SURFACE_ALBEDO_INCREMENT, REFERENCE_SURFACE_RELATIVE_HUMIDITY,
    SEA_ICE_EQUILIBRIUM_THICKNESS_M, SEA_ICE_THERMAL_CONDUCTIVITY_W_M_K,
    STANDARD_ATMOSPHERE_SEA_LEVEL_TEMPERATURE_C, STANDARD_GRAVITY_M_S2,
