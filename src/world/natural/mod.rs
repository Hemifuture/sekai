...
pub use global_circulation::{
    ...
    large_scale_condensation_kg_m2_s, linearized_outgoing_longwave_w_m2,
    ...
    GLOBAL_CIRCULATION_TANGENCY_TOLERANCE_M_S, GLOBAL_CIRCULATION_TOA_NET_ABS_MAX_W_M2,
    ...
    STEFAN_BOLTZMANN_CONSTANT_W_M2_K4, WATER_VAPORIZATION_LATENT_HEAT_J_KG,
};
#[cfg(test)]
