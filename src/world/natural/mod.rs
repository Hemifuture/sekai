...
pub use global_circulation::{
    ...
    GLOBAL_CIRCULATION_ENERGY_RELATIVE_ERROR_MAX, GLOBAL_CIRCULATION_FAST_CFL_TARGET,
    GLOBAL_CIRCULATION_FORMATION_CYCLES_MAX, GLOBAL_CIRCULATION_FORMATION_RESIDUAL_MAX,
    GLOBAL_CIRCULATION_MACRO_STEP_SECONDS, GLOBAL_CIRCULATION_MINIMUM_FAST_SUBSTEPS_PER_MACRO_STEP,
    GLOBAL_CIRCULATION_RADIATIVE_FLUX_MAX_W_M2, GLOBAL_CIRCULATION_REFERENCE_WAVE_SPEED_M_S,
    ...
    OPEN_WATER_REFERENCE_WIND_SPEED_M_S, OPEN_WATER_SENSIBLE_HEAT_TRANSFER_COEFFICIENT,
    P4_DRY_AIR_SPECIFIC_HEAT_CAPACITY_J_KG_K, P4_EBM_DIFFUSION_W_M2_K,
    P4_HIGHLAND_ALBEDO_RAMP_ONSET_M, P4_HIGHLAND_ALBEDO_RAMP_SPAN_M,
    P4_HIGHLAND_SURFACE_ALBEDO_INCREMENT, P4_LARGE_SCALE_CONDENSATION_RELATIVE_HUMIDITY,
    P4_LARGE_SCALE_CONDENSATION_RELAXATION_SECONDS, P4_LOWER_LAYER_REFERENCE_PRESSURE_PA,
    P4_MAX_SPECIFIC_HUMIDITY_KG_KG, P4_OPEN_OCEAN_SURFACE_ALBEDO, P4_REFERENCE_AIR_DENSITY_KG_M3,
    P4_SEA_ICE_SURFACE_ALBEDO, P4_SNOW_FREE_LAND_SURFACE_ALBEDO_INCREMENT,
    REFERENCE_SURFACE_RELATIVE_HUMIDITY, SEA_ICE_EQUILIBRIUM_THICKNESS_M,
    SEA_ICE_THERMAL_CONDUCTIVITY_W_M_K, STANDARD_GRAVITY_M_S2, STEFAN_BOLTZMANN_CONSTANT_W_M2_K4,
