use sekai::rules::{
    ...
    geologic_model_capability_id, CapabilityContribution, CoreSchemaRange, GeologicModel,
    GeologicRuleResolution, GeologicRuleResolutionError, GeologicRuleResolver, RulePack,
