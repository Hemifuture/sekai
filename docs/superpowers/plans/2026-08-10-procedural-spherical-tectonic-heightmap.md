...
src/generators/natural/spherical_tectonics/model.rs
    Formation recipe plus transient sample, active-lineage, contact and two-buffer workspace types.
...
- [ ] **Step 1: Write V3 construction, serde and rejection tests**
...
- [ ] **Step 3: Implement the V3 struct-of-arrays contract**
...
- [ ] **Step 1: Write noise and recipe RED tests**
...
- [ ] **Step 3: Move the existing coherent core and implement bounded sparse Gabor**
...
- [ ] **Step 4: Add formation recipes and labeled streams**
...
- Modify: `src/generators/natural/spherical_tectonics.rs`
- Test: module tests in `model.rs` and `initial_state.rs`
- Test: `tests/spherical_tectonic_generation.rs`

**Interfaces:**
- Consumes: surface cells/adjacency, `TectonicSpec`, `FormationTectonicRecipe`, shared noise and labeled streams.
- Produces: `LineageId`, `CrustSample`, `ActivePlate`, `TectonicState`, `TectonicWorkspace`, `InitialStateError`, `build_initial_state`.

- [ ] **Step 1: Write initial-state RED tests**
...
- [ ] **Step 3: Implement compact current/next state types**
...
- [ ] **Step 4: Implement mature initial conditions**
...
- [ ] **Step 5: Run focused tests and mutation check**
...
- [ ] **Step 3: Implement one shared kinematics path**
...
- [ ] **Step 4: Run focused and existing rotation tests**
...
- [ ] **Step 3: Implement read-only coverage and contact construction**
...
- [ ] **Step 4: Run focused tests and source-boundary guard**
...
```powershell
git add src/generators/natural/spherical_tectonics.rs src/generators/natural/spherical_tectonics/model.rs src/generators/natural/spherical_tectonics/contacts.rs
...
- [ ] **Step 1: Write paper-curve RED tests**
...
- [ ] **Step 3: Implement pure transfer functions and mutations**
...
- [ ] **Step 4: Run tests and deliberate side-selection mutation**
...
```powershell
git add src/generators/natural/spherical_tectonics.rs src/generators/natural/spherical_tectonics/model.rs src/generators/natural/spherical_tectonics/processes
...
- [ ] **Step 3: Implement the three orthogonal modules**
...
Derive one draw per `(step, lineage)` from `counter_u64("rift-events-v3", &[step, lineage])`; there is no mutable draw order and no step-by-lineage allocation. Use the paper's perturbed Voronoi fracture inside the selected plate domain only. `relax_current_crust` increments ages, applies oceanic subsidence, linear continental erosion and trench sediment in one indexed pass.
...
- [ ] **Step 4: Run process suite and capacity mutation**
...
- [ ] **Step 1: Write resampling/canonicalization RED tests**
...
- [ ] **Step 4: Implement final connected-component normalization**
...
- [ ] **Step 5: Run focused tests and owner-preservation mutation**
...
- [ ] **Step 1: Write end-to-end RED tests against the wished V3 behavior**
...
- [ ] **Step 4: Assemble V3 and final boundaries atomically**
...
- [ ] **Step 5: Run focused/adjacent tests and deliberate old-owner mutation**
...
- [ ] **Step 1: Write height causality RED tests**
...
- [ ] **Step 3: Implement the one-way component builder**
...
- [ ] **Step 4: Integrate with mantle without coupling modules**
...
- [ ] **Step 5: Run focused/adjacent tests and no-deformation guard**
...
- [ ] **Step 3: Update adapters and downstream expectations**
...
- [ ] **Step 4: Run complete spherical natural integration**
...
- [ ] **Step 1: Replace obsolete shape contracts with RED oracles**
...
- [ ] **Step 2: Add direct process causality oracles**
...
- [ ] **Step 3: Run semantic acceptance and tune only documented constants**
...
- [ ] **Step 4: Run deliberate causality and anti-Voronoi mutations**
...
- [ ] **Step 1: Add an ignored atlas generator**
...
- [ ] **Step 4: Refresh exact GPU hashes only after semantic and visual GREEN**
...
- [ ] **Step 5: Exercise the shipped native and browser canvases**
...
- [ ] **Step 1: Write the Release budget RED gate**
...
- [ ] **Step 2: Run Release performance gate**
...
- [ ] **Step 3: Prove no presentation-time recomputation or deformation**
...
- [ ] **Step 4: Run all engineering gates fresh**
...
- [ ] **Step 5: Final source and requirement audit**
