...
- **A5（2026-08-22，T0 测高校准 Task 4）——探针指纹刷新。** T0 校准
  （规格 `2026-08-21-t0-hypsometric-calibration-design`）改变了 T0 输入，
  草稿档、种子 42、M1 烘焙 LOD（L=4）探针 blake3 刷新为
  `20fb2405f60ea634b2153474a06f2103fc059073479ba8414ac297c164e36ea5`
  （A3 所记 `ab8bc747…` 自本修订起由本值取代）；放大器算法与常量未动，
  由 `tests/surface_formation_stage.rs` 守门。